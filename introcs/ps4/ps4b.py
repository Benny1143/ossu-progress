...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(lowercase)):
            ...
            if pos >= 26:
                pos -= 26
            dic[lowercase[i]] = lowercase[pos]
            dic[lowercase[i].upper()] = lowercase[pos].upper()
        return dic
    ...
    def apply_shift(self, shift):
        ...
        return ''.join(dic.get(letter, letter) for letter in self.message_text)
...
if __name__ == '__main__':
    ...
    print('Expected Output: crrng')
    print('Actual Output:', plaintext.get_message_text_encrypted())

    plaintext = PlaintextMessage('orange', 2)
    print('Expected Output: qtcpig')
    print('Actual Output:', plaintext.get_message_text_encrypted())

    ciphertext = CiphertextMessage('crrng')
    print('Expected Output:', (24, 'apple'))
    print('Actual Output:', ciphertext.decrypt_message())

    ciphertext = CiphertextMessage('qtcpig')
    print('Expected Output:', (24, 'orange'))
    print('Actual Output:', ciphertext.decrypt_message())
